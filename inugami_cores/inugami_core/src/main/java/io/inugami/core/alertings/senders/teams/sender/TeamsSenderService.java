...
public class TeamsSenderService implements Sender<TeamsModel>, Serializable {
    ...
    public void init() {
        ...
        if (enable) {
            Asserts.assertNotNull("base url is mandatory!", urlBase);
            Asserts.assertNotNull("context url is mandatory!", urlContext);
            Asserts.assertNotNull("token is mandatory!", urlToken);
            Asserts.assertNotNull("incoming token is mandatory!", urlIncomingToken);
        }
