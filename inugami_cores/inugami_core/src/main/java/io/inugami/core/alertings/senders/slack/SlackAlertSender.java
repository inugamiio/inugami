 ...
 * @since 20 mars 2018
 */
@SuppressWarnings({"java:S2139", "java:S1452"})
@Named
public class SlackAlertSender implements AlertsSender, Serializable {
    ...
    protected SlackAlertSender(final ApplicationContext context, final Sender<ISlackModel<?>> sender,
    ...
    // BUILD
    // =========================================================================
    protected ISlackModel<?> buildNewAlert(final AlertingResult alert) throws RenderingException {
