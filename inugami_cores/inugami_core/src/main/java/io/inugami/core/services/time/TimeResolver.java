 ...
 * @since 11 oct. 2016
 */
@SuppressWarnings({"java:S6397", "java:S116", "java:S6353", "java:S6353"})
public class TimeResolver {
    ...
    public int resolveCalendarField(final String from) {
        ...
        if (matcher.matches()) {
            ...
            final MapKeyTime enumTime = MapKeyTime.getEnum(time);
            result = enumTime == null ? null : enumTime.getField();
        }
        return result;
    }
    ...
    private enum MapKeyTime {
        ...
        private static final List<MapKeyTime> VALUES = Arrays.asList(values());
        private final        int              calendarField;

        private final String[] matching;

        public static List<MapKeyTime> getValues() {
            return VALUES;
        }

        private MapKeyTime(final int calendarField, final String[] matching) {
        ...
        public static synchronized MapKeyTime getEnum(final String value) {
            MapKeyTime result = null;
            if (value != null) {

                for (final MapKeyTime item : MapKeyTime.getValues()) {
