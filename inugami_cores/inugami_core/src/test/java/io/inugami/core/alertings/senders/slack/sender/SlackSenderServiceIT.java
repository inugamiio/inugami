...
class SlackSenderServiceIT {
    ...
    void testSend() throws Exception {
        ...
        final Sender<ISlackModel<?>> sender = SlackSenderService.builder()
                                                                .context(ctx)
                                                                .build();
        ...
        final SlackSimpleModel data = new SlackSimpleModel("#" + chanel, "test" + System.currentTimeMillis(),
                                                           "#" + tag);
