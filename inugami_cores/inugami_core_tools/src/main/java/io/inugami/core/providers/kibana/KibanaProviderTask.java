 ...
 * @since 2 oct. 2017
 */
@SuppressWarnings({"java:S3655", "java:S1117"})
public class KibanaProviderTask implements ProviderTask {
    ...
    public ProviderFutureResult callProvider() {
        ...
        Asserts.assertTrue("from is mandatory", event.getFrom().isPresent());
        Asserts.assertTrue("until is mandatory", event.getUntil().isPresent());
        try {
