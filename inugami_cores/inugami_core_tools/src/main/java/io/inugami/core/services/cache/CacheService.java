 ...
 * @since 17 janv. 2017
 */
@SuppressWarnings({"java:S2095", "java:S3740", "java:S1640"})
public class CacheService {
    ...
    public Cache<String, Serializable> getCache(final CacheTypes type) {
        final Cache<String, Serializable> result = caches.get(type);
        Asserts.assertNotNull("unable to find cache : " + type, result);
        return result;
    }
