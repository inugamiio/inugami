...
public class TimeResolver {
    ...
    public int resolveCalendarField(final String from) {
        ...
        if (matcher.matches()) {
            ...
            Asserts.assertNotNull("unkwnon tiem type : " + time, timeType);
    ...
    private enum MapKeyTime {
        //@formatter:off
        YEAR(Calendar.YEAR, "y", "Y"),
        MONTH(Calendar.MONTH, "M"),
        WEEK(Calendar.WEEK_OF_YEAR, "w", "W"),
        DAY(Calendar.DAY_OF_MONTH, "d", "D"),
        HOUR(Calendar.HOUR_OF_DAY, "h", "H"),
        MINUTE(Calendar.MINUTE, "m", "min"),
        SECOND(Calendar.SECOND, "s"),
        MILLISECOND(Calendar.MILLISECOND, "S");
        //@formatter:on
