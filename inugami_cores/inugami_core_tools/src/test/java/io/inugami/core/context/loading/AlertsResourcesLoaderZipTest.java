 ...
 * @since 27 déc. 2017
 */
class AlertsResourcesLoaderZipTest implements TestUnitResources {

    // =========================================================================
    // LOAD ALERTING RESOURCES
    // =========================================================================
    @Test
    void testResolveJarFile() throws Exception {
    ...
    @Test
    void testLoadAlertingsResources() throws Exception {
    ...
    @Test
    void testSortsJavaScriptResources() throws Exception {
