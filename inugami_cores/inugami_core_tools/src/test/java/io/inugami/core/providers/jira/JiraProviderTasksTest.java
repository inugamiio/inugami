...
class JiraProviderTasksTest implements TestUnitResources {
    // =========================================================================
    // ATTRIBUTES
    // =========================================================================
    ...
    void testBuildResult() throws Exception {
        ...
        final ProviderFutureResult result = task.buildResult(new SimpleEventBuilder().addName("jiraEvent")
                                                                                     .addQuery(JQL_QUERY)
                                                                                     .build(), httpConnector.get(""));
