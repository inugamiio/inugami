 ...
 */
package io.inugami.dashboard.interfaces.domain.administration.dto;
...
class PingDTOTest {
    ...
    void pingDTO() {
        assertDto(AssertDtoContext.<PingDTO>builder()
                                  ...
                                  .fullArgConstructorRefPath("io/inugami/dashboard/interfaces/domain/administration/dto/pingDTO/model.json")
                                  .getterRefPath("io/inugami/dashboard/interfaces/domain/administration/dto/pingDTO/getter.json")
                                  .toStringRefPath("io/inugami/dashboard/interfaces/domain/administration/dto/pingDTO/toString.txt")
