 ...
 */
package org.inugami.core.alertings.messages;
...
public final class FormatAlertMessage {
    ...
    private static AlertMessageDataExtractorSPI resolveExtractor(final String key, final AlertingResult alert) {
        ...
        final List<AlertMessageDataExtractorSPI> extractors = SPI_LOADER.loadSpiServicesWithDefault(AlertMessageDataExtractorSPI.class,
