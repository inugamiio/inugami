 ...
 */
package org.inugami.core.context.system;
...
import org.inugami.core.cdi.scheduler.SchedulerSystem;
import org.inugami.core.context.Context;
import org.inugami.core.model.system.CpuUsage;
import org.inugami.core.model.system.JvmMemoryUsage;
import org.inugami.core.model.system.SimpleThreadInfo;
import org.inugami.core.model.system.ThreadsUsage;
...
public class SystemInfoJob implements Job {
    ...
    private void applyThreadsSecurity(final int nbThreads) {
        ...
        final int percent = new Double((new Double(nbThreads) / max_threads) * 100).intValue();
        ...
        if (percent > minAcceptable) {
            ...
            final AlertingResult alert = new AlertingResult("system.too.many.threads.running");
            alert.setCreated(System.currentTimeMillis());
            alert.setMessage("_system.too.many.threads.running");
            alert.setData(json.toJsonObject());
