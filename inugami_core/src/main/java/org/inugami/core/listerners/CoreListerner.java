 ...
 */
package org.inugami.core.listerners;

import org.inugami.api.exceptions.services.EventProcessException;
import org.inugami.api.listeners.EngineListener;
import org.inugami.api.loggers.Loggers;
import org.inugami.api.models.data.ClientSendData;
...
public class CoreListerner implements EngineListener {
    ...
    private final Logger LOGGER = LoggerFactory.getLogger(EngineListener.class);
    ...
    public void onStartDayTimeChange(final String startDayTime) {
        LOGGER.info("start time change for : {}", startDayTime);
    }
    ...
    public void onErrorInRunningJob(final String message, final Exception exception) {
        if (exception instanceof EventProcessException) {
            final String fullMessage = renderMsgEventProcessExcept(message, (EventProcessException) exception);
    ...
    // render
    // =========================================================================
    private String renderMsgEventProcessExcept(final String message, final EventProcessException exception) {
