...
class UnitTestHelperStubTest {
    ...
    // ========================================================================
    @Test
    void loadIntegrationTestStub_withoutFolder_shouldThrow() {
        final List<UserDto> cache = new ArrayList<>();
    ...
    @Test
    void loadIntegrationTestStub_withoutIdExtractor_shouldThrow() {
        final List<UserDto> cache        = new ArrayList<>();
    ...
    @Test
    void loadIntegrationTestStub_withoutClass_shouldThrow() {
        final List<UserDto> cache        = new ArrayList<>();
