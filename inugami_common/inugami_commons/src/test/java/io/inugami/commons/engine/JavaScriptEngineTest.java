 ...
 * @since 20 déc. 2017
 */
class JavaScriptEngineTest implements FunctionMustThrow {
    ...
    // =========================================================================
    @Test
    void testCheckScriptInnerFunction() throws Exception {
    ...
    @Test
    void testBuildFunction() throws Exception {
        final JavaScriptEngine engine = new JavaScriptEngine();
    ...
    @Test
    void textExecute() throws Exception {
        final JavaScriptEngine engine = new JavaScriptEngine();
