...
public class InugamiMonitoringConfig {
    ...
    @Bean
    public MonitoringBootstrap initMonitoringContext(final EmbeddedValueResolver resolver) {
    ...
    private void initializeConfig(final EmbeddedValueResolver resolver) {
    ...
    private String orDefault(final String key, final String defaultValue,
        ...
        String value = null;
        try {
            value = resolver.resolveStringValue("${" + key + "}");
        }
        catch (Exception e) {
