...
@SuppressWarnings({"java:S3358", "java:S112"})
@Slf4j
@Aspect
@Component
...
public class FeatureAopAspect {
    ...
    private Object interceptFeature(final ProceedingJoinPoint jointPoint, final FeatureContext featureContext) throws Throwable {
        Object       result = null;
    ...
    private FeatureContext resolveFeatureDTO(final ProceedingJoinPoint jointPoint) {
        ...
        final Feature feature = ReflectionUtils.getAnnotation(method, Feature.class);
        return feature == null
                ? null
                : FeatureContext.builder()
                                ...
                                .propertyPerfix(feature.propertyPrefix().isEmpty() ? bean.getName() : feature.propertyPrefix())
    ...
    private Object onDone(final Object inputResult, final Throwable error, final Chrono chrono, final FeatureContext featureContext) {
