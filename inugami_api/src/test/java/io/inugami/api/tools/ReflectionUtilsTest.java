...
class ReflectionUtilsTest {
    ...
    void scanJar_nominal() throws IOException, URISyntaxException {
        final URL          jarUrl = UnitTestHelper.buildTestFilePath("inugami-springboot-demo-user-webapp.jar").toURI().toURL();
    ...
    void extractFieldGetterAndSetter_nominal() {
        assertThat(extractFieldGetterAndSetter(SomeService.builder().name("Joe").build())).hasToString("[FieldGetterSetter(field=private java.lang.String io.inugami.api.tools.ReflectionUtilsTest$SomeService.name, value=Joe, getter=public java.lang.String io.inugami.api.tools.ReflectionUtilsTest$SomeService.getName(), setter=public void io.inugami.api.tools.ReflectionUtilsTest$SomeService.setName(java.lang.String))]");
    ...
    void extractGetters_nominal() {
        assertThat(extractGetters(SomeService.builder().name("Joe").build())).hasToString("[public java.lang.String io.inugami.api.tools.ReflectionUtilsTest$SomeService.getName()]");
        assertThat(extractGetters(SomeService.builder().build())).hasToString("[public java.lang.String io.inugami.api.tools.ReflectionUtilsTest$SomeService.getName()]");
    ...
    void sortMethods_nominal() {
        ...
        sortMethods(methods);
        assertThat(methods).hasToString("[public static io.inugami.api.tools.ReflectionUtilsTest$SomeService$SomeServiceBuilder io.inugami.api.tools.ReflectionUtilsTest$SomeService.builder(), public boolean java.lang.Object.equals(java.lang.Object), public final native java.lang.Class java.lang.Object.getClass(), public java.lang.String io.inugami.api.tools.ReflectionUtilsTest$SomeService.getName(), public java.lang.String io.inugami.api.tools.ReflectionUtilsTest$ParentService.getUrl(), public native int java.lang.Object.hashCode(), public final native void java.lang.Object.notify(), public final native void java.lang.Object.notifyAll(), public void io.inugami.api.tools.ReflectionUtilsTest$SomeService.setName(java.lang.String), public void io.inugami.api.tools.ReflectionUtilsTest$ParentService.setUrl(java.lang.String), public java.lang.String java.lang.Object.toString(), public final native void java.lang.Object.wait(long) throws java.lang.InterruptedException, public final void java.lang.Object.wait(long,int) throws java.lang.InterruptedException, public final void java.lang.Object.wait() throws java.lang.InterruptedException]");
        sortMethods(null);
    }
    ...
    private String splitResult(final Set<Class<?>> test) {
        return String.join("\n", Optional.ofNullable(test).orElse(Set.of()).stream().map(c -> c.getName()).collect(Collectors.toList()));
    }
