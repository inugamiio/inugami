...
public class DefaultWarningTest {
    ...
    public void addDetail_nominal_shouldAddDetail() {
        assertThat(WarningErrorCode.REQUEST_REQUIRE.addDetail("simple message {0}", "hello").toString())
                .isEqualTo("DefaultWarning(warningCode=HTTP-1, message=request is require, messageDetail=simple message hello, warningType=functional, category=null, domain=null, subDomain=null)");
    }
