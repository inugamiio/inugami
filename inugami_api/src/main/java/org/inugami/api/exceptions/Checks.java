...
public final class Checks {
    ...
    public static <E extends CheckedException> void isTrue(final boolean expression,final BiFunction<ErrorCode, String,E> errorBuilder) throws E {
        isTrue("this expression must be true",
               expression,
               errorBuilder);
    }
    ...
    public static <E extends CheckedException> void isFalse(final boolean expression,final BiFunction<ErrorCode, String,E> errorBuilder) throws E {
        isFalse("this expression must be true",
                expression,
                errorBuilder);
    }
    ...
    public static <E extends CheckedException> void isNull(final BiFunction<ErrorCode, String,E> errorBuilder,final Object... objects) throws E {
        isNull("objects arguments must be null",
               errorBuilder,
               objects);
    }
    ...
    public static <E extends CheckedException> void notNull(final BiFunction<ErrorCode, String,E> errorBuilder,final Object... objects) throws E {
        notNull("this argument is required; it must not be null",
                errorBuilder,
                objects);
    }
    ...
    private static <E extends CheckedException> void throwException(String message,final BiFunction<ErrorCode, String,E> exceptionBuilder) throws E {
    ...
    private static <E extends CheckedException> void  throwException(final ErrorCode errorCode,final BiFunction<ErrorCode, String,E> exceptionBuilder) throws E {
