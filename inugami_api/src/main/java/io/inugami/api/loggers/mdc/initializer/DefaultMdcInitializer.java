...
public class DefaultMdcInitializer implements MdcInitializerSpi {
    ...
    public Map<String, Serializable> getDefaultValue() {
        return Map.ofEntries(
                ...
                buildEntry(MdcService.MDCKeys.messageId,DEFAULT_STRING),
                buildEntry(MdcService.MDCKeys.healthStatus,"up"),
                ...
                buildEntry(MdcService.MDCKeys.callType,DEFAULT_STRING),
