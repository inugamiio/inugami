...
class WarningEmpty {
    ...
    static void warningEmpty(final Warning warning, final String value, final String messageDetail, final Object... msgArgs) {
    ...
    static void warningEmpty(final Warning warning, final Collection<?> values, final String messageDetail, final Object... msgArgs) {
    ...
    static <T> void warningEmpty(final Warning warning, final T[] values, final String messageDetail, final Object... msgArgs) {
        if (values == null || values.length == 0) {
            WarningCommons.addWarningInContext(warning, messageDetail, msgArgs);
        }
    }
    ...
    static void warningEmpty(final Warning warning, final Map<?, ?> values, final String messageDetail, final Object... msgArgs) {
        if (values == null || values.isEmpty()) {
            WarningCommons.addWarningInContext(warning, messageDetail, msgArgs);
        }
    }
