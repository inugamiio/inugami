...
import io.inugami.framework.commons.files.zip.ZipScanerBuilder;
import io.inugami.framework.interfaces.scan.ScanResources;
...
public final class MockJsonScanJar implements ScanResources<List<String>> {
    ...
    public List<String> scan() throws IOException {
        ...
        ZipScanerBuilder.builder(jarPath)
                        .addZipScanProcessor(this::matchesJsResources,(zipEntry, zipFile)->result.add(zipEntry.getName()))
                       .scan();
        //@formatter:on
        return result;
    }
