...
import io.inugami.framework.interfaces.models.NumberType;
...
public class AggregatorHelper {
    ...
    public <N extends Number, K> Map<K, N> sumMap(final Map<K, N> ref, final Map<K, N> newValue) {
        ...
        final Map<K, N> result    = new HashMap<>();
    ...
    // KEEP RECORD
    // =================================================================================================================
    public Record keepRecord(final double value,
        ...
        if (previousRecord == null) {
            result = Record.builder().time(timestamp).value(value).unit(unit).build();
        } else {
