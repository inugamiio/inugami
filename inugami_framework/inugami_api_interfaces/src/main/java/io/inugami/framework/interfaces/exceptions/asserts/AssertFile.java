...
public final class AssertFile {
    ...
    public void assertFileExists(final File path) {
        Asserts.assertNotNull(() -> MessagesFormatter.format(FILE_NOT_EXISTS, path), path);
        if (!path.exists()) {
    ...
    public void assertFileExists(final ErrorCode errorCode, final File path) {
        Asserts.assertNotNull(errorCode, path);
        if (!path.exists()) {
    ...
    public void assertFolderExists(final File path) {
        Asserts.assertNotNull(() -> MessagesFormatter.format(FOLDER_NOT_EXISTS, path), path);
        if (!path.exists()) {
