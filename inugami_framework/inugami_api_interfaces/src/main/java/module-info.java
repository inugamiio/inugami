...
open module io.inugami.framework.interfaces {
    ...
    uses io.inugami.framework.interfaces.monitoring.TrackingInformationSPI;
    ...
    uses io.inugami.framework.interfaces.monitoring.logger.mapper.MdcDynamicFieldSPI;
    ...
    uses io.inugami.framework.interfaces.spi.PropertiesProducerSpi;
    uses io.inugami.framework.interfaces.alertings.AlertingProvider;
    uses io.inugami.framework.interfaces.listeners.EngineListener;
