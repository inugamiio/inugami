...
class FunctionalUtilsTest {
    ...
    // =================================================================================================================
    @Test
    void ifNotNull_nominal() {
        final Integer size = ifNotNull("hello", t -> t.length());
        assertThat(size).isEqualTo(5);

        final Integer sizeOther = ifNotNull(null, t -> String.valueOf(t).length());
        assertThat(sizeOther).isNull();
    }
