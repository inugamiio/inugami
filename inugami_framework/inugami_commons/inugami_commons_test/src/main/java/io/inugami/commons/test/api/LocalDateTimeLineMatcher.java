...
@SuppressWarnings({"java:S5843", "java:S6395", "java:S6353"})
@Builder(toBuilder = true)
@AllArgsConstructor
public class LocalDateTimeLineMatcher implements LineMatcher {
    private static final Pattern       REGEX = Pattern.compile(".*[0-9]{4}-((0[1-9])|(1[0-2]))-(([0-2][0-9])|(3[0-1]))(?:T)(([0-1][0-9])|(2[0-3])):(([0-4][0-9])|5[0-9]):(([0-4][0-9])|5[0-9]).*");
