...
class GavTest {
    ...
    void gav() {
        assertDto(new AssertDtoContext<Gav>().toBuilder()
                                             ...
                                             .fullArgConstructorRefPath("io/inugami/framework/api/models/gav/model.json")
                                             .getterRefPath("io/inugami/framework/api/models/gav/getter.json")
                                             .toStringRefPath("io/inugami/framework/api/models/gav/toString.txt")
