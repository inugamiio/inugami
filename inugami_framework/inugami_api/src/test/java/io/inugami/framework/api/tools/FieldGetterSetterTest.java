...
class FieldGetterSetterTest {
    ...
    void fieldGetterSetter() {
        assertDto(new AssertDtoContext<FieldGetterSetter>().toBuilder()
                                                           ...
                                                           .fullArgConstructorRefPath("io/inugami/framework/api/tools/fieldGetterSetterTest/model.json")
                                                           .toStringRefPath("io/inugami/framework/api/tools/fieldGetterSetterTest/toStringRefPath.txt")
