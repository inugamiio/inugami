...
class RgbTest {
    ...
    void rgb() {
        assertDto(new AssertDtoContext<Rgb>().toBuilder()
                                             ...
                                             .fullArgConstructorRefPath("io/inugami/framework/api/models/rgb/model.json")
                                             .getterRefPath("io/inugami/framework/api/models/rgb/getter.json")
                                             .toStringRefPath("io/inugami/framework/api/models/rgb/toString.txt")
