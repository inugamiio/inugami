...
class TupleTest {
    ...
    void tuple() {
        assertDto(new AssertDtoContext<Tuple>().toBuilder()
                                               ...
                                               .fullArgConstructorRefPath("io/inugami/framework/api/models/tuple/model.json")
                                               .getterRefPath("io/inugami/framework/api/models/tuple/getter.json")
                                               .toStringRefPath("io/inugami/framework/api/models/tuple/toString.txt")
