 ...
 */
package io.inugami.framework.api.monitoring.models;

import flexjson.JSON;
import io.inugami.framework.api.mapping.DateTransformer;
import io.inugami.framework.api.models.data.graphite.number.GraphiteNumberTransformer;
...
@Setter
@Getter
public final class GenericMonitoringModelDto implements GenericMonitoringModel, Dto, Identifiable<String> {
