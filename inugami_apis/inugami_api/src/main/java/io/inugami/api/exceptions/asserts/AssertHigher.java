...
public final class AssertHigher {
    ...
    // ========================================================================
    // ------------------------------------------------------------------------
    public void assertHigher(final int ref,
                             final int value) {
    ...
    public void assertHigher(final String message,
                             final int ref,
                             final int value) {
        if (ref >= value) {
    ...
    public void assertHigher(final Supplier<String> messageProducer,
                             final int ref,
                             final int value) {
        if (ref >= value) {
    ...
    public void assertHigher(final ErrorCode errorCode,
                             final int ref,
                             final int value) {
        if (ref >= value) {
    ...
    // ------------------------------------------------------------------------
    public void assertHigher(final long ref,
                             final long value) {
        assertHigher(DEFAULT_MESSAGE,
                     ref,
                     value);
    ...
    // ------------------------------------------------------------------------
    public void assertHigher(final float ref,
                             final float value) {
        assertHigher(DEFAULT_MESSAGE,
                     ref,
                     value);
    ...
    // ------------------------------------------------------------------------
    public void assertHigher(final double ref,
                             final double value) {
        assertHigher(DEFAULT_MESSAGE,
                     ref,
                     value);
    ...
    // ------------------------------------------------------------------------
    public void assertHigher(final Integer ref,
                             final Integer value) {
        assertHigher(DEFAULT_MESSAGE,
                     ref,
                     value);
    ...
    // ------------------------------------------------------------------------
    public void assertHigher(final BigDecimal ref,
