...
class JsonBuilderTest {
    ...
    @Test
    void writeListJsonObject_nominal() {
        assertThat(new JsonBuilder().writeListJsonObject(List.of(DataPoint.builder()
                                                                          .value(2.0)
                                                                          .timestamp(1L)
                                                                          .build(),
                                                                 DataPoint.builder()
    ...
    @Test
    void writeListJsonObject_null() {
        assertThat(new JsonBuilder().writeListJsonObject(null))
                .hasToString("null");
    }

    @Test
    void toJsonObject_nominal() {
        assertThat(new JsonBuilder().openObject()
                                    .writeParam(NAME, "Joe")
                                    .closeObject()
                                    .toJsonObject()).hasToString("{\"name\":\"Joe\"}");
    }
