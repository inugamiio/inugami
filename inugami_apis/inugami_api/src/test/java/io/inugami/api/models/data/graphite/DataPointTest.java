...
class DataPointTest {
    ...
    void dataPoint() {
        assertDto(new AssertDtoContext<DataPoint>().toBuilder()
                                                   ...
                                                   .fullArgConstructorRefPath("api/models/data/graphite/dataPoint/model.json")
                                                   .getterRefPath("api/models/data/graphite/dataPoint/getter.json")
                                                   .toStringRefPath("api/models/data/graphite/dataPoint/toString.txt")
