...
class ErrorCodeTest {
    ...
    void assertGetter_nominal() {
        assertTextRelative(LogInfoDTO.builder()
                                     ...
                                     .build()
                                     .toString(),
                           "api/exceptions/errorCodeTest/assertGetter_nominal.txt");
    }
    ...
    void assertGetter_empty() {
        assertTextRelative(LogInfoDTO.builder()
                                     ...
                                     .with(ErrorCode.ERROR_HANDLER, ERROR_CODE_EMPTY.getErrorHandler() != null)
                                     .with(ErrorCode.CATEGORY, ERROR_CODE_EMPTY.getCategory())
                                     .with(ErrorCode.FIELD, ERROR_CODE_EMPTY.getField())
                                     .build()
                                     .toString(),
                           "api/exceptions/errorCodeTest/assertGetter_empty.txt");
    }
