 ...
 * @since 26 déc. 2016
 */
public class EventFileConfigurationLoaderTest {
    ...
    // =========================================================================
    @Test
    public void testLoadFromFile() throws TechnicalException {
        try {
            process();
        }
    ...
    private void process() throws TechnicalException {
        ...
        Optional<EventConfig> configOpt;
        try {
